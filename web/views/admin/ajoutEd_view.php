<div class='container' style='padding-top:60px;'>
	<h2 style="color:#DE6A1C">Ajouter une catégorie</h2>
	<br />
	<form method="post" action="?page=ajoutCat" enctype="application/x-www-form-urlencoded" name="modification"  onSubmit="return check3();"/>
