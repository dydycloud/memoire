<div class='container' style='padding-top:60px;'>
	...
	<form method="post" action="?page=gestionMembre" enctype="application/x-www-form-urlencoded" name="inscription"  onSubmit="return check();"/>
		<div class="clearfix">
			<label for="pseudo"><b style="color:red">*</b>Pseudo</label>
			<div class="input">
			  <input class="xlarge" id="pseudo" name="pseudo" size="30" type="text" value="<?php if(isset($article['pseudo'])) echo htmlentities(trim($article['pseudo'])); ?>">
			</div>
		</div>
		<div class="clearfix">
